...
// Array containing all of the modules
    ...
    //A - FR
        ModuleConstants.builder()
            ...
            .THROTTLE_MOTORID(1)
            .CANCODER_ID(0)
            .CANCODER_OFFSET(Rotation2d.fromRotations(0.22192))
            .INVERTED(false)
            .build(),
    //B - BL
        ModuleConstants.builder()
            ...
            .THROTTLE_MOTORID(3)
            .CANCODER_ID(1)
            .CANCODER_OFFSET(Rotation2d.fromRotations(-0.2307))
            .INVERTED(true)
            .build(),
    //C BR
        ModuleConstants.builder()
            ...
            .THROTTLE_MOTORID(5)
            .CANCODER_ID(2)
            .CANCODER_OFFSET(Rotation2d.fromRotations(0.114))
            .INVERTED(false)
            .build(),
    //D - FL
        ModuleConstants.builder()
            ...
            .THROTTLE_MOTORID(7)
            .CANCODER_ID(3)
            .CANCODER_OFFSET(Rotation2d.fromRotations(0.4921))
            .INVERTED(true)
            .build()
    };
